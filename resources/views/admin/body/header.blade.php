<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            @php
                $id = Auth::user()->id;
                $adminData = \App\Models\User::all()->find($id);
            @endphp
            ...
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{route('admin.change.password')}}"><i class="bx bx-user"></i><span>Parolayı Değiştir</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item" href="{{route('admin.logout')}}"><i class='bx bx-log-out-circle'></i><span>Çıkış Yap</span></a>
                    </li>
                </ul>
            </div>
        </nav>
